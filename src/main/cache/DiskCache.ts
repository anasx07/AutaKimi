...
export class DiskCache {
  constructor(private cacheDir: string, private maxSizeBytes: number) {
  ...
  private fireAndForgetEviction() {
    this.evict().catch((e) => console.error('[DiskCache] Eviction failed:', e))
  }
  ...
  async evict(): Promise<void> {
    ...
    if (currentSize <= this.maxSizeBytes) return
