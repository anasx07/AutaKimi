    ...
    <div className="relative w-full overflow-hidden flex-shrink-0 pt-4 px-6 pb-6 border-b border-border/10">
      {manga.coverUrl && (
        <div className="absolute inset-0 z-0">
          <img src={manga.coverUrl} alt="" className="w-full h-full object-cover blur-3xl opacity-35 saturate-150 scale-125" />
          ...
          <div className="space-y-1">
            ...
            <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-xs sm:text-sm">
              ...
              <span className="text-muted-foreground font-medium flex items-center gap-1.5">
                <Tooltip content={`Browse ${extension?.name || manga.pkg?.split('.').pop()}`} position="top">
                  <button
