    ...
    <div className="flex h-full bg-background overflow-hidden animate-in fade-in duration-700">
      ...
      <aside className="w-80 border-r border-border/60 bg-secondary/10 backdrop-blur-3xl flex flex-col p-6 gap-8">
        <div className="space-y-1.5 px-2">
          <h1 className="text-3xl font-black tracking-tighter bg-gradient-to-br from-foreground to-muted-foreground bg-clip-text text-transparent uppercase italic">
            L.Settings
          </h1>
            ...
            <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  >
                    <Cloud className="h-5 w-5 group-hover:-translate-y-1 transition-transform" />{' '}
                    Reset Session Data
                  </Button>
                </div>
              </section>
